...
House/techno, 124 BPM, A minor. Ten files in `data/raw/`, 16-bit LE PCM mono
22050 Hz, 544 KB total. Generated by `make_samples.py`.
...
| 6 | 06_stab_em (E G B) | cyan |
| 7 | 07_sub (A1) | magenta |
| 8 | 08_pluck (E4) | magenta |
| 9 | 09_riser | magenta |

Reference implementation of mixer + quantiser: `simulator.py` (Engine class).
Grid at 124 BPM = 2667 samples = 121 ms. Mixer: bed x0.80, one-shots x0.85,
then tanh(x * 0.62) * 1.15. Bed stops after 8 s without a press.
